...
<div class="container">
  ...
  <div class="row100">
    <div class="col">
      <div class="inputBox">
      <input type="text" name="yubin" id="yubin" required="required" placeholder="160-0023" value="<?php  foreach($menber as $value){ echo $value['postalcode'];}?>">
    ...
    <div class="col">
      <div class="inputBox">
      <input type="text" name="phone" id="phone" required="required" placeholder="03-3344-1010" value="<?php  foreach($menber as $value){ echo $value['phonenumber'];}?>">
